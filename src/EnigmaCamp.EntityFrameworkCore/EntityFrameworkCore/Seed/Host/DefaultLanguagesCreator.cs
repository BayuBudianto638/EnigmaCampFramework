...
namespace EnigmaCamp.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly EnigmaCampDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = EnigmaCampConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(EnigmaCampDbContext context)
        {
            _context = context;
        }
