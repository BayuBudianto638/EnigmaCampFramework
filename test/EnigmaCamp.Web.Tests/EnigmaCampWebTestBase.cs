...
{
    public abstract class EnigmaCampWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EnigmaCampWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EnigmaCampWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<EnigmaCampDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<EnigmaCampDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EnigmaCampDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EnigmaCampDbContext, Task<T>> func)
        {
            T result;
